...
if [[ "${DOC}" == "1" ]]; then
  if [[ -x "$(command -v help2man)" ]]; then
    ...
    help2man -n "ncurses mail" -N -o src/nmail.1 ./build/nmail && ${SED} "s/\.\\\\\" DO NOT MODIFY THIS FILE\!  It was generated by help2man.*/\.\\\\\" DO NOT MODIFY THIS FILE\!  It was generated by help2man./g" src/nmail.1 && ${SED} "s/^Combined distribution subject to.*/License varies by build configuration.\n.br\nSee \`nmail \-\-version\` for details./g" src/nmail.1 || exiterr "doc failed, exiting."
  fi
fi
