...
# Build a pattern matching 12 bytes to wrap the array at 12 columns. Assembled
# with a loop rather than string(REPEAT) to stay compatible with CMake 3.14.
set(LINE_PATTERN "")
foreach(i RANGE 1 12)
  string(APPEND LINE_PATTERN "0x[0-9a-f][0-9a-f], ")
endforeach()
